...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // F6 - Notifications (WhatsApp, SMS, appel vocal)
    ...
    // F7 - Génération de reçus PDF et attestations
